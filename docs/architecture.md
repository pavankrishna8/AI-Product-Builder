...
- FastAPI + Pydantic gives request/response validation almost for free, which matters since the frontend and AI output both need to be trusted at the boundary.
